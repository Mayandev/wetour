...
export default class Index extends Component {
  ...
  buildShare() {
    return (
      <View className="share-container at-row at-row__align--center">
        <View className="share-txt">分享至：</View>
        <View className="share-item at-row at-row__align--center at-row__justify--center">
        ...
        <View className="share-item at-row at-row__align--center at-row__justify--center">
          <Image src={weibo} className="share-icon"></Image>
          <View className="">微博</View>
        </View>
      </View>
    );
  }
